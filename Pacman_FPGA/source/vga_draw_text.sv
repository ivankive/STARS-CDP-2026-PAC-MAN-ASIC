...
/*
assign draw_s = (h_count == 10'b10) && (h_count < 10'b10 + 8);
assign draw_c = (h_count == 1) && (h_count < 10'b10 + 16);
assign draw_o = (h_count == 2) && (h_count < 10'd8);
assign draw_r = (h_count == 3) && (h_count < 10'd8);
assign draw_e = (h_count == 4) && (h_count < 10'd8);
  ...
  always_comb begin
      if (draw_s && video_on)begin
        ...
        casez (pixel_y)
          ...
          3'd2 : output_rgb = (pixel_x ==1 || pixel_x == 2)?         3'b110 : 3'b000;
          3'd3 : output_rgb = (pixel_x ==1 || pixel_x == 2)?         3'b110 : 3'b000;
          3'd4 : output_rgb = (pixel_x ==1 || pixel_x == 2)?         3'b110 : 3'b000;
          3'd5 : output_rgb = (pixel_x ==1 || pixel_x == 2)?         3'b110 : 3'b000;
        ...
        casez (pixel_y)
          3'd0 : output_rgb  =  3'b111;
          3'd1 : output_rgb  =  3'b111;
          3'd2 : output_rgb = (pixel_x < 3 || pixel_x > 6)?          3'b110 : 3'b000;
          3'd3 : output_rgb = (pixel_x < 3 || pixel_x > 6)?          3'b110 : 3'b000;
          3'd4 : output_rgb = (pixel_x < 3 || pixel_x > 6)?          3'b110 : 3'b000;
          3'd5 : output_rgb = (pixel_x < 3 || pixel_x > 6)?          3'b110 : 3'b000;
          3'd6 : output_rgb  =  3'b111;
          3'd7 : output_rgb  =  3'b111; 
        endcase
        ...
        casez (pixel_y)
          ...
          3'd3 : output_rgb = (pixel_x > 0)?                                                   3'b110 : 3'b000;
          3'd4 : output_rgb = (pixel_x > 0 || pixel_x < 6)?          3'b110 : 3'b000;
          3'd5 : output_rgb = ((pixel_x > 1 && pixel_x < 3)|| (pixel_x > 3 && pixel_x < 7))?   3'b110 : 3'b000;
        ...
        casez (pixel_y)
          ...
          3'd2 : output_rgb = (pixel_x == 3 || pixel_x == 2)?        3'b110 : 3'b000;
          3'd3 : output_rgb = (pixel_x> 1 && pixel_x < 7)?           3'b111 : 3'b000;
          3'd4 : output_rgb = (pixel_x> 1 && pixel_x < 7)?           3'b111 : 3'b000;
          3'd5 : output_rgb = (pixel_x == 3 || pixel_x == 2)?        3'b110 : 3'b000;
