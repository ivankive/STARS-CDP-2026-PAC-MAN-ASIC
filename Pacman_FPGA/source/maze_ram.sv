module maze_ram (
    ...
    input  logic [4:0] x_pacman,
    input  logic [4:0] y_pacman,
    ...
    // Reload FSM: async initial ROM -> live row-packed Maze RAM
    ...
    // Port A: VGA read-only
    assign rdata_vga = in_bounds(x_vga, y_vga)? maze_rows[y_vga][55 - (x_vga * 2) -: 2] : WALL_TILE;
